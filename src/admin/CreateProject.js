      ...
      <form noValidate onSubmit={handleSubmit} className="mt-1">
        ...
        <div className="mb-3">
          ...
          <input
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            className={`block w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 ${touched.titleBn && errors.titleBn ? 'border-red-500' : ''}`}
          />
        ...
        <div className="mb-3">
          ...
          />
          {touched.titleEs && errors.titleEs && <p className="text-red-500 text-sm">{errors.titleEs}</p>}
        </div>
        ...
        <div className="mb-3">
          ...
          <textarea
            id="contentBn"
            name="contentBn"
            placeholder="Write the project contentBn..."
            rows={4}
        ...
        <div className="mb-3">
          ...
          <textarea
            id="contentEs"
            name="contentEs"
            placeholder="Write the project contentEs..."
            rows={4}
