...
const validationSchema = yup.object({
  ...
  distanceEn: yup
    .string("Add text distance in English")
    .min(1, "distance must have at least 1 character")
    .required("Text distance in English is required"),
    distanceBn: yup
    .string("Add text distance in Bengali")
    .min(1, "distance must have at least 1 character")
    .required("Text distance in bengali is required"),
  distanceEs: yup
    .string("Add text distance in Danish")
    .min(1, "distance must have at least 1 character")
    .required("Text distance in Danish is required"),
});

const CreateLocalBenifits = () => {
...
export default CreateLocalBenifits;
