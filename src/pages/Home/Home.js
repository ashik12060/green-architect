...
const Home = () => {
  ...
  return (
    <>
      ...
      <div  className={`text-center my-10 font-bold  ${isDarkMode ? ' text-white' : 'text-black'}`}>
        <h3 className={`text-3xl  text-center my-10 font-bold  ${isDarkMode ? ' text-white' : 'text-black'}`}><span className={`text-center my-10 font-bold  ${isDarkMode ? ' text-white border-b-4 border-white' : 'text-black border-b-4 border-black'}`}>{t('projects')}</span></h3>
        <OurProjects />
      ...
      >
       <FontAwesomeIcon icon={faCalendarDays} className="pe-2 text-xl" /> {t('schedule_meeting')}
      </button>
    </div>
      <Footer />
 ...
 {showPopup && (
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg w-96 transition-transform transform hover:scale-105">
            <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">{t('popup_title')}</h2>
            <form>
              ...
              <label className="block mb-4">
                <span className="text-gray-700">{t('form.email')}</span>
                <input
                  type="email"
                  name="email"
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 transition duration-200"
              ...
              <label className="block mb-4">
                <span className="text-gray-700">{t('form.message')}</span>
                <textarea
                  id="message"
                  name="message"
                  rows="4"
