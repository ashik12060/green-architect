...
function Footer() {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-evenly items-start gap-8">
          ...
          <div className="lg:w-1/3">
            ...
            <div className="py-4">
              <a href="/" className="hover:text-blue-300">
                <FontAwesomeIcon icon={faLocationDot} /> {t('footer.contact.address')}
              </a>
            </div>
          ...
          <div className="lg:w-1/3">
            <h5 className="font-bold text-xl mb-4">{t('footer.contact.quickLinks')}</h5>
  ...
  <h5 className="font-bold text-xl mb-4">{t('footer.form.getInTouch')}</h5>
