...
//         <div className="text-center md:text-left">
//           <a href="/" className="hover:text-blue-300">
//             <FontAwesomeIcon icon={faLocationDot} className="mr-2" /> {translations[language].location}
//           </a>
//         </div>
...
//         <div className="text-center">
//           <a href="/" className="hover:text-blue-300">
//             <FontAwesomeIcon icon={faPhoneVolume} className="mr-2" /> {translations[language].phone}
//           </a>
//         </div>
