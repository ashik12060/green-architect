...
//     office: "Our Office",
//     officeAddress: "Suite 2203, Level-R, Multicomplex, Gulshan 1, Dhaka 1212, Bangladesh",
//     callUs: "Call Us",
//     phone: "+8801711-001726",
//     emailUs: "Email Us",
//     email: "info@architectcompany.com",
//     workingHours: "Working Hours",
//     workingHoursDetails: "Saturday - Thursday: 10am - 7pm\nFriday: Closed",
...
//     office: "আমাদের অফিস",
//     officeAddress: "সুইট 2203, লেভেল-আর, মাল্টিকমপ্লেক্স, গুলশান 1, ঢাকা 1212, বাংলাদেশ",
//     callUs: "আমাদের কল করুন",
//     phone: "+8801711-001726",
//     emailUs: "আমাদের ইমেল করুন",
//     email: "info@architectcompany.com",
//     workingHours: "কর্মঘণ্টা",
//     workingHoursDetails: "শনিবার - বৃহস্পতিবার: সকাল ১০টা - সন্ধ্যা ৭টা\nশুক্রবার: বন্ধ",
//     requestQuote: "একটি ফ্রি কোটের জন্য অনুরোধ করুন",
//     yourName: "আপনার নাম",
//     yourEmail: "আপনার ইমেইল",
//     yourPhone: "আপনার ফোন নম্বর",
//     projectDetails: "প্রকল্পের বিস্তারিত",
//     writeQuery: "আপনার প্রশ্ন লিখুন",
//     submitRequest: "অনুরোধ জমা দিন",
//     findUsOnMap: "গুগল ম্যাপে আমাদের খুঁজুন",
//   },
// };
...
//         <div className="absolute inset-0 bg-black opacity-50"></div>
//         <div className="relative z-10 flex items-center justify-center h-full">
//           <h1 className="text-4xl font-bold text-white">{translations[language].title}</h1>
//         </div>
//       </div>
...
//                 </div>
//                 <div>
//                   <h3 className="text-2xl font-bold text-gray-900">{translations[language].office}</h3>
//                   <p className="text-gray-900">{translations[language].officeAddress}</p>
//                 </div>
//               </div>
...
//                 </div>
//                 <div>
//                   <h3 className="text-2xl font-bold text-gray-900">{translations[language].callUs}</h3>
//                   <p className="text-gray-900">{translations[language].phone}</p>
//                 </div>
//               </div>
...
//                 </div>
//                 <div>
//                   <h3 className="text-2xl font-bold text-gray-900">{translations[language].emailUs}</h3>
//                   <p>
//                     <a
...
//                 </div>
//                 <div>
//                   <h3 className="text-2xl font-bold text-gray-900">{translations[language].workingHours}</h3>
//                   <p className="text-gray-900">{translations[language].workingHoursDetails}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//           <div>
//             <h2 className={`text-3xl font-semibold mb-8 ${isDarkMode ? 'text-white' : 'text-black'}`}>
//               {translations[language].requestQuote}
//             </h2>
//             <form className="space-y-6">
//               <div>
...
//                 <input
//                   type="number"
//                   placeholder={translations[language].yourPhone}
//                   id="number"
//                   className="border border-gray-300 rounded-lg py-2 px-4 w-full focus:ring-2 focus:ring-green-500 focus:outline-none"
//                 />
//               </div>
...
//                   {translations[language].projectDetails}
//                 </label>
//                 <textarea
//                   id="projectDetails"
//                   rows="5"
//                   placeholder={translations[language].writeQuery}
//                   className="border border-gray-300 rounded-lg py-2 px-4 w-full focus:ring-2 focus:ring-green-500 focus:outline-none"
//                 ></textarea>
//               </div>
...
//         <div className="container mx-auto">
//           <h2 className="text-3xl font-semibold text-center mb-8">
//             {translations[language].findUsOnMap}
//           </h2>
//           <div className="flex justify-center">
//             <iframe
//               title="Google Map"
