...
const Design = () => {
  const { t } = useTranslation('Service');  // Using the 'design' namespace for translations

  const designItems = [
    { path: '/design/master-planing', label: t('masterPlanning'), icon: faMapMarkedAlt },
    { path: '/design/infrastructure', label: t('infrastructure'), icon: faRoad },
    { path: '/design/architecture', label: t('architecture'), icon: faBuilding },
    { path: '/design/structure', label: t('structure'), icon: faDraftingCompass },
    { path: '/design/electrical', label: t('electrical'), icon: faBolt },
    { path: '/design/mechanical', label: t('mechanical'), icon: faCogs },
    { path: '/design/plumbing', label: t('plumbing'), icon: faFaucet },
    { path: '/design/lighting', label: t('lighting'), icon: faLightbulb },
    { path: '/design/leed-consultancy', label: t('leedConsultancy'), icon: faLeaf },
    { path: '/design/model-making', label: t('modelMakingg'), icon: faLeaf },
  ];
