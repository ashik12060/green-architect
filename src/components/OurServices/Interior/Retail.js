...
const Retail = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 text-center bg-white text-gray-800">
      {/* Header Section */}
      <h1 className="text-3xl font-bold mb-4">{t("retailInteriorDesignHeader")}</h1>
      <p className="text-lg mb-8">{t("retailInteriorDesignIntroText")}</p>

      {/* Subheading */}
      <h2 className="text-2xl font-semibold mb-6">{t("retailInteriorDesignServices")}</h2>
      ...
      <div className="space-y-6 max-w-4xl w-full">
        ...
        />
        <ServiceItem
          title={t("visualMerchandisingTitle")}
          description={t("visualMerchandisingDescription")}
        />
        <ServiceItem
          title={t("brandIntegrationTitle")}
          description={t("brandIntegrationDescription")}
        />
        <ServiceItem
        ...
        />
        <ServiceItem
          title={t("fixtureFurnitureDesignTitle")}
          description={t("fixtureFurnitureDesignDescription")}
        />
        <ServiceItem
          title={t("colorMaterialSelectionTitle")}
          description={t("colorMaterialSelectionDescription")}
        />
        <ServiceItem
