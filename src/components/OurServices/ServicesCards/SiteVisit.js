...
const SiteVisit = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 text-center bg-white text-gray-800">
      <h1 className="text-3xl font-bold mb-4 px-4 sm:px-8 md:px-16">
        {t('siteAssessmentTitle')}
      </h1>
      <p className="text-lg mb-8 px-4 sm:px-8 md:px-16">
        {t('siteAssessmentIntro')}
      </p>

      <h2 className="text-2xl font-semibold mb-6 px-4 sm:px-8 md:px-16">
        {t('siteAssessmentHighlights')}
      </h2>

      <div className="space-y-6 max-w-4xl w-full">
        <ServiceItem
          title={t('accurateMeasurements')}
          description={t('accurateMeasurementsDescription')}
        />
        <ServiceItem
        ...
        />
        <ServiceItem
          title={t('conditionAssessment')}
          description={t('conditionAssessmentDescription')}
        />
        <ServiceItem
          title={t('highQualityImagery')}
          description={t('highQualityImageryDescription')}
        />
        <ServiceItem
          title={t('stakeholderMeetings')}
          description={t('stakeholderMeetingsDescription')}
        />
      </div>
    </div>
  );
