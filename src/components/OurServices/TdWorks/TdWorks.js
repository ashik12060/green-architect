...
const TdWorks = () => {
  const { t } = useTranslation('Service');  // Using the 'TdWorks' namespace for translations

  const sections = [
    { title: t('technical'), link: '/3d-works/technical', icon: faDraftingCompass },
    { title: t('oilGas'), link: '/3d-works/oil-gas', icon: faGasPump },
    { title: t('construction'), link: '/3d-works/construction-3d', icon: faBuilding },
    { title: t('products'), link: '/3d-works/products-3d', icon: faCube },
    { title: t('solar'), link: '/3d-works/solar-3d', icon: faSun },
    { title: t('gameCinema'), link: '/3d-works/game-cinema', icon: faFilm },
    { title: t('archBD'), link: '/3d-works/arch', icon: faLandmark },
    { title: t('archGlobal'), link: '/3d-works/arch-global', icon: faGlobe },
    { title: t('vrWorks'), link: '/3d-works/vs-works', icon: faVrCardboard },
  ];
