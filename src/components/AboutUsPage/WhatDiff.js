...
//         <h1 className="text-3xl text-center my-10 pb-10 font-bold text-green-800 mb-4 "><span className={`${isDarkMode ? 'border-b-4 border-white text-white  ' : 'text-green-700 border-b-4 border-green-700'}`}>{t('title')}</span></h1>
    ...
    <div>
      <div className={`flex flex-col items-center justify-center min-h-screen ${isDarkMode ? 'text-white bg-black' : 'bg-white'}`}>
        <motion.div
          ...
          className={`container mx-auto p-4 rounded-lg shadow-md ${isDarkMode ? 'text-white bg-black shadow-gray-800' : ''}`}
        >
