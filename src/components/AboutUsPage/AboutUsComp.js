...
function AboutUsComp() {
  ...
  return (
    <>
      <div className="border flex flex-col items-center justify-center min-h-screen fa-100">
        <motion.div
        ...
        >
          <h1 className="text-3xl text-center my-1 pb-10 font-bold mb-4">
            <motion.span
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <motion.div
              ...
              className="md:w-1/2"
            >
              <img src={img} alt="Building Image" className="border border-gray-200 w-full rounded-lg shadow-sm" />
            </motion.div>
            {/* Text Section */}
            <motion.div
              initial={{ opacity: 0, x: 100 }}
